...
|     ![Carrots](assets/crops/carrots.png) **Carrots**      | `Red`    |   `Common`:&nbsp;8 | `Red Alert`: when Harvested, gain 1 **Coin** for every other growing `Red` [Crop](#crops) in the game                                                                                                                                   | 1            | 3          | 1          | 2   |
...
|                ![Weed Whacker](/assets/actions/weed_whacker.png) **Weed Whacker**                | 2          | `Uncommon`:&nbsp;4 |     | Gain 1 **Coin** per every [Card](#cards) in [Hand](#hand)                                                                                                                                                                                                                                                                                    | 
...
|       ![Grim Reaper](assets/classes/grim_reaper.png) **Grim Reaper**       | +2 [Fertilizers](#fertilizers)                  | 1&nbsp;`Common`<br/> 2&nbsp;`Raised`                                               | ![Rip And Sow](assets/actions/reap_and_sow.png) `Rip And Sow`:  once per game, choose a [Crop](#crops) `Color`. All Opponents give you all their [Crop Cards](#crop-cards) of that `Color`, if they have any                           | 3 [Fertilizers](#fertilizers) |
