...
| `Grocery Composture`     | 1    | `Mythical`:&nbsp;1 | Roll d6 for each unit of this **Card** value. Gain as many **Fertilizers**                                                                                                              |
                                                                                 |
| `Drought`                | 4    | `Mythical`:&nbsp;1 | All currently growing **Crops** have their _Ripe Timer_ increased by 2                                                                                                                  |
...
|:--------------------------------------------------------------------------:|----------------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------|
|        ![Land Baron](assets/classes/land_baron.png) **Land Baron**         | +2 **Coins**                     | 1 Common, 2 Greenhouse               | `Land Acquisition`: once per game, restore any previously discarded **Card** to your hand                                         | 2 **Fertilizers** |
|       ![Grim Reaper](assets/classes/the_reaper.png) **Grim Reaper**        | +2 **Fertilizers**               | 1 Common, 2 Raised                   | `Reap and Sow`:  once per game, call a **Crop** type. All Opponents give you their **Crop Cards** of their type, if they have any | 2 **Fertilizers** |
| ![Master Gardener](assets/classes/master_gardener.png) **Master Gardener** | +1 `Common Bed`                  | 4 Common                             | `Early Bird`: once per game, transform any of your **Beds** into `Trellis`,`Rotational Bed` or `Vertical Bed`                     | 2 **Fertilizers** |
|  ![Crop Scientist](assets/classes/crop_scientist.png) **Crop Scientist**   | +1 Random Common **Action Card** | 1 Common, 2 Hydroponic               | `Genetic Modification`: once per game, all your growing **Crops** have their `Crop Value` increased by 2                          | 2 **Fertilizer**  |
|       ![Seed Trader](assets/classes/seed_trader.png) **Seed Trader**       | +1 Random Common **Crop Card**   | 1 Common, 1 Greenhouse, 1 Raised     | `Black Friday`: Discard all **Cards** from _Market_ and your _Hand_. For every **Card** discarded, gain **1 Coin**                | 2 **Fertilizers** |
| ![Weather Watcher](assets/classes/weather_watcher.png) **Weather Watcher** | +1 **Fertilizer**, +1 **Coin**   | 1 Common, 1 Greenhouse, 1 Hydroponic | `Cloud Cover`: once per game, pick an Opponent. All their growing **Crops** have their `Reap Timer`  increased by 1 turn.         | 2 **Fertilizers** |
