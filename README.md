...
| :---------------------------------------------------------------------------------------------------: | ----------------------------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
|        ![Land Baron](/assets/thumbs/assets/classes/SMALL/avif/land_baron.avif) **Land Baron**         | +2 [Coins](#coins)                              | 1&nbsp;`Common`<br/> 2&nbsp;`Greenhouse`                                           | ![Land Reclamation](assets/actions/land_reclamation.png) `Land Reclamation`: once per game, pick a [Card](#cards) you previously discarded and add two copies of it to your [Hand](#hand)                                               | 4 [Fertilizers](#fertilizers) |
|       ![Grim Reaper](/assets/thumbs/assets/classes/SMALL/avif/grim_reaper.avif) **Grim Reaper**       | +2 [Fertilizers](#fertilizers)                  | 1&nbsp;`Common`<br/> 2&nbsp;`Raised`                                               | ![Rip And Sow](/assets/thumbs/assets/actions/MEDIUM/avif/reap_and_sow.avif) `Rip And Sow`: once per game, choose a [Crop](#crops) `Color`. All Opponents give you all their [Crop Cards](#crop-cards) of that `Color`, if they have any | 3 [Fertilizers](#fertilizers) |
| ![Master Gardener](/assets/thumbs/assets/classes/SMALL/avif/master_gardener.avif) **Master Gardener** | Extra [Beds](#garden-beds)                      | 1&nbsp;`Common`<br/>1&nbsp;`Trellis`<br/>1&nbsp;`Vertical`<br/>1&nbsp;`Rotational` | ![Early Bird](assets/actions/early_bird.png) `Early Bird`: once per game, Harvest all your growing [Crops](#crops) immediately. Draw a [Card](#cards) from the [Deck](#deck)                                                            | 3 [Fertilizers](#fertilizers) |
|  ![Crop Scientist](/assets/thumbs/assets/classes/SMALL/avif/crop_scientist.avif) **Crop Scientist**   | +1 Random `Common` [Action Card](#action-cards) | 1&nbsp;`Common`<br/>2&nbsp;`Hydroponic`                                            | ![Genetic Modification](assets/actions/genetic_modification.png) `Genetic Modification`: once per game, all your growing [Crops](#crops) have their `Crop Value` doubled                                                                | 2 [Fertilizer](#fertilizers)  |
|       ![Seed Trader](/assets/thumbs/assets/classes/SMALL/avif/seed_trader.avif) **Seed Trader**       | +1 Random `Common` [Crop Card](#crop-cards)     | 1&nbsp;`Common`<br/> 1&nbsp;`Greenhouse`<br/> 1&nbsp;`Raised`                      | ![Black Friday](assets/actions/black_friday.png) `Black Friday`: All Players ' _[Hand](#hand)s_ are returned to the [Deck](#deck). [Market](#market) [Cards](#cards) are discarded. For every [Card](#cards) affected, gain **1 Coin**  | 4 [Fertilizers](#fertilizers) |
| ![Weather Watcher](/assets/thumbs/assets/classes/SMALL/avif/weather_watcher.avif) **Weather Watcher** | +1 [Fertilizer](#fertilizers), +1 **Coin**      | 1&nbsp;`Common`<br/> 1&nbsp;`Greenhouse`<br/> 1&nbsp;`Hydroponic`                  | ![Cloud Cover](assets/actions/cloud_cover.png) `Cloud Cover`: once per game, chosen Opponent's [Crops](#crops) randomly add 1d4 to their `Reap Timer`.                                                                                  | 2 [Fertilizers](#fertilizers) |
