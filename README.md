...
| The Reaper      | +2 Random Common **Crop Card**    | 2 Common, 2 Raised               | `Reap and Sow (replayable)`: once per turn, swap any other **Card** with a random **Card** from _Deck_                                                                                     | 1 **Fertilizers** |
...
| Seed Trader     | +3 **Coins**                      | 2 Common, 1 Raised, 1 Greenhouse | `Stonks`: once per game, pick a **Card** from the _Market_ and add it to your hand. Then, discard all the other **Cards** in the _Market_ and refill it with new **Cards** from the _Deck_ | 3 **Fertilizers** |
