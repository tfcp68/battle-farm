import { ExtKeysT, extTypes, TAssetNamesDict, TBaseAsset, TBaseAssetSize } from './assetBuilderTypes';
...
export function importAll<K extends TAssetNamesDict>(
	...
	dict: Partial<Record<TBaseAsset<K>, Record<TBaseAssetSize<K>, Partial<Record<ExtKeysT, string>>>>>
) {
	f.keys().forEach((key) => {
