...
Coins are symbolic tokens that represent the Game score of a Player and can be expended to acquire [Cards](#cards).
...
There is a total of **204** [Cards](#cards) in a Deck, having 5 different [rarities](#rarity), that define their
...
[Cards](#cards) are the main expendable source of the Game. There is a set quantity of each [Card](#cards) in
...
When played, a [Crop Card](#crop-cards) must be planted (placed) in an empty **Garden Bed**, becoming the
...
manages to Harvest an Opponent's Plant with an [Action Card](#action-cards), they are to apply its Effect as the Crop was
theirs.
...
|:--------------------------------------------------------------------------------------:|----------|-------------------:|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------|------------|-----|
|        ![Wheat](../assets/thumbs/assets/crops/SMALL/jpeg/wheat.jpeg) **Wheat**         | `Yellow` |   `Common`:&nbsp;8 | `Bake it Up`: when Fertilized, increases its Crop Value by 2                                                                                                                                                                            | 1            | 2          | 1          | 1   |
|       ![Cherry](../assets/thumbs/assets/crops/SMALL/jpeg/cherry.jpeg) **Cherry**       | `Red`    |   `Common`:&nbsp;8 | `Cherry Picking`: when Harvested, all other `Common` [Cards](#cards) in your [Hand](#hand) gain 1 extra `Card Value`                                                                                                                    | 1            | 2          | 1          | 1   |
|     ![Cabbage](../assets/thumbs/assets/crops/SMALL/jpeg/cabbage.jpeg) **Cabbage**      | `Green`  |        `Common`: 8 | `Head of Green`: when Harvested, gain 1 **Coin** for every other growing `Green` [Crop](#crops) in the game                                                                                                                             | 1            | 2          | 1          | 1   |
|          ![Corn](../assets/thumbs/assets/crops/SMALL/jpeg/corn.jpeg) **Corn**          | `Yellow` |   `Common`:&nbsp;8 | `Yellow Patch`: when Harvested, gain 1 **Coin** for every other growing `Yellow` [Crop](#crops) in the game                                                                                                                             | 1            | 3          | 1          | 2   |
|     ![Carrots](../assets/thumbs/assets/crops/SMALL/jpeg/carrots.jpeg) **Carrots**      | `Red`    |   `Common`:&nbsp;8 | `Red Alert`: when Harvested, gain 1 **Coin** for every other growing `Red` [Crop](#crops) in the game                                                                                                                                   | 1            | 3          | 1          | 2   |
|       ![Onions](../assets/thumbs/assets/crops/SMALL/jpeg/onion.jpeg) **Onions**        | `Green`  |   `Common`:&nbsp;8 | `Onion Ring`: when Planted, gain 1 [Fertilizer](#fertilizers) for every other `Onion` in your [Hand](#hand) and 1 **Coin** for every `Onion` [Crop](#crops) you have growing                                                            | 1            | 3          | 1          | 2   |
|        ![Mango](../assets/thumbs/assets/crops/SMALL/jpeg/mango.jpeg) **Mango**         | `Yellow` | `Uncommon`:&nbsp;6 | `Mango Madness`: when Planted, pick and Opponent. Per every [Crop](#crops) they have growing, they must swap a [Card](#cards) from their [Hand](#hand) with a random [Card](#cards) from [Deck](#deck)                                  | 2            | 5          | 2          | 1.5 |
|       ![Tomato](../assets/thumbs/assets/crops/SMALL/jpeg/tomato.jpeg) **Tomato**       | `Red`    | `Uncommon`:&nbsp;6 | `Catch up`: gains +1&nbsp;`Crop Value` for every Opponent with more [Coins](#coins) than you                                                                                                                                            | 2            | 5          | 2          | 1.5 |
|       ![Potato](../assets/thumbs/assets/crops/SMALL/jpeg/potato.jpeg) **Potato**       | `Green`  | `Uncommon`:&nbsp;6 | `Root Rot`: when Harvested, roll 1d4. If you roll 4, get a `Potato` [Card](#cards), otherwise gain 1 [Fertilizer](#fertilizers)                                                                                                         | 2            | 5          | 2          | 1.5 |
|        ![Melon](../assets/thumbs/assets/crops/SMALL/jpeg/melon.jpeg) **Melon**         | `Yellow` | `Uncommon`:&nbsp;6 | `Melon Mania`: gain 1d4 extra [Coins](#coins) for the 2nd and the following `Melon` Harvested                                                                                                                                           | 2            | 6          | 2          | 2   |
|        ![Beans](../assets/thumbs/assets/crops/SMALL/jpeg/beans.jpeg) **Beans**         | `Red`    | `Uncommon`:&nbsp;6 | `Beanstalk`: when Harvested, swap a [Card](#cards) from your [Hand](#hand) with a random one from [Deck](#deck)                                                                                                                         | 2            | 6          | 2          | 2   |
|       ![Wasabi](../assets/thumbs/assets/crops/SMALL/jpeg/wasabi.jpeg) **Wasabi**       | `Green`  | `Uncommon`:&nbsp;6 | `Radish Rally`: when Planted, steal 1d4 [Coins](#coins) from a chosen Opponent, if you have another `Wasabi` in [Hand](#hand)                                                                                                           | 2            | 6          | 2          | 2   |
|  ![Pineapple](../assets/thumbs/assets/crops/SMALL/jpeg/pineapple.jpeg) **Pineapple**   | `Yellow` |     `Rare`:&nbsp;4 | `Pineapple Punch`: when Harvested, destroy a [Crop](#crops) of your choice and return it's [Card](#cards) to [Deck](#deck)                                                                                                              | 3            | 9          | 3          | 2   |
|    ![Eggplant](../assets/thumbs/assets/crops/SMALL/jpeg/eggplant.jpeg) **Eggplant**    | `Red`    |     `Rare`:&nbsp;4 | `Eggplant Emoji`: when Planted, pick a Player. They lose 1 **Coin** per every [Card](#cards) in their [Hand](#hand)                                                                                                                     | 3            | 9          | 3          | 2   | 
|      ![Peppers](../assets/thumbs/assets/crops/SMALL/jpeg/pepper.jpeg) **Peppers**      | `Green`  |     `Rare`:&nbsp;4 | `Spicy Sprinkle`: when Harvested, roll 1d6. That many `Card Value` is distributed among your [Crop Cards](#crop-cards) in [Hand](#hand) (randomly)                                                                                      | 3            | 9          | 3          | 2   |
|  ![Tangerine](../assets/thumbs/assets/crops/SMALL/jpeg/tangerine.jpeg) **Tangerine**   | `Yellow` |     `Epic`:&nbsp;2 | `Sweet and Sour`: when Planted and Harvested, all your other [Crops](#crops) gain 1 Value                                                                                                                                               | 5            | 15         | 4          | 2.5 |
|     ![Pumpkin](../assets/thumbs/assets/crops/SMALL/jpeg/pumpkin.jpeg) **Pumpkin**      | `Red`    |     `Epic`:&nbsp;2 | `Trick or Treat`: when Harvested, all Players give you 1 **Coin** for every [Fertilizer](#fertilizers) they have                                                                                                                        | 5            | 15         | 4          | 2.5 |
|        ![Grapes](../assets/thumbs/assets/crops/SMALL/jpeg/grape.jpeg) **Grape**        | `Green`  |     `Epic`:&nbsp;2 | `Grapevine`: when Harvested from `Common Bed` or `Raised Bed`, transform it into `Hydroponics`. Otherwise gain extra 4 [Coins](#coins)                                                                                                  | 5            | 15         | 4          | 2.5 |
| ![Cloudberry](../assets/thumbs/assets/crops/SMALL/jpeg/cloudberry.jpeg) **Cloudberry** | `Yellow` |   `Mythic`:&nbsp;1 | `Berry Blitz`: when Planted, the [Card](#cards) with the biggest `Card Value` from each Opponents' [Hand](#hand) has its `Card Value` reduced to 1 and is returned to [Deck](#deck)                                                     | 8            | 21         | 5          | 2.6 |
| ![Strawberry](../assets/thumbs/assets/crops/SMALL/jpeg/strawberry.jpeg) **Strawberry** | `Red`    |   `Mythic`:&nbsp;1 | `Ripe for the Picking`: when Harvested, pick any other [Crop](#crops) on the field. Gain its `Crop Value` in [Coins](#coins)                                                                                                            | 8            | 23         | 5          | 3   |
|  ![Blueberry](../assets/thumbs/assets/crops/SMALL/jpeg/blueberry.jpeg) **Blueberry**   | `Green`  |   `Mythic`:&nbsp;1 | `Blueberry Boom`: when Planted, pick an Opponent's [Bed](#garden-beds). It's downgraded to a `Common Bed`, and its [Crop](#crops), if any, is destroyed. If the [Bed](#garden-beds) was a `Greenhouse`, the [Crop](#crops) is preserved | 8            | 22         | 5          | 2.8 |
...
|:----------------------------------------------------------------------------------------------------------------------------:|------------|-------------------:|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|             ![Garden Gourmet](../assets/thumbs/assets/actions/SMALL/jpeg/garden_gourmet.jpeg) **Garden Gourmet**             | 1          |   `Common`:&nbsp;6 | Choose a growing [Crop](#crops) and add the `Card Value` to that `Crop Value`                                                                                                                                                                                                                                                                |
|        ![Fertilizer Frenzy](../assets/thumbs/assets/actions/SMALL/jpeg/fertilizer_frenzy.jpeg) **Fertilizer Frenzy**         | 1          |   `Common`:&nbsp;6 | Choose a growing [Crop](#crops). For each grade of that [Crop](#crops) Rarity, reduce it's `Crop Value` by 1 (1 for `Common`, 2 for `Uncommon`, etc.), down to 0                                                                                                                                                                             |
|                       ![Recycle](../assets/thumbs/assets/actions/SMALL/jpeg/recycle.jpeg) **Recycle**                        | 0          |   `Common`:&nbsp;6 | Discard a [Card](#cards) from your [Hand](#hand), along with this one. For each grade of that [Card](#cards) Rarity, gain 1 [Fertilizers](#fertilizers) (1 for Common, 2 for Uncommon, etc.), and 1 more for this [Card](#cards)                                                                                                             |
|                   ![Lucky Find](../assets/thumbs/assets/actions/SMALL/jpeg/lucky_find.jpeg) **Lucky Find**                   | 1          |   `Common`:&nbsp;6 | Gain 1d4 [Coins](#coins)                                                                                                                                                                                                                                                                                                                     |
|                    ![Green Day](../assets/thumbs/assets/actions/SMALL/jpeg/green_day.jpeg) **Green Day**                     | 1          |   `Common`:&nbsp;6 | All `Green` [Crop Cards](#crop-cards) in your [Hand](#hand) increase their `Card Value` by 1                                                                                                                                                                                                                                                 |
|                      ![Red Heat](../assets/thumbs/assets/actions/SMALL/jpeg/red_heat.jpeg) **Red Heat**                      | 1          |   `Common`:&nbsp;6 | All `Red` [Crop Cards](#crop-cards) in your [Hand](#hand) increase their `Card Value` by 1                                                                                                                                                                                                                                                   |
|                 ![Yellow Gold](../assets/thumbs/assets/actions/SMALL/jpeg/yellow_gold.jpeg) **Yellow Gold**                  | 1          |   `Common`:&nbsp;6 | All `Yellow` [Crop Cards](#crop-cards) in your [Hand](#hand) increase their `Card Value` by 1                                                                                                                                                                                                                                                |
|                ![Weed Whacker](../assets/thumbs/assets/actions/SMALL/jpeg/weed_whacker.jpeg) **Weed Whacker**                | 2          | `Uncommon`:&nbsp;4 | Gain 1 **Coin** per every [Card](#cards) in [Hand](#hand)                                                                                                                                                                                                                                                                                    | 
|                ![Pest Control](../assets/thumbs/assets/actions/SMALL/jpeg/pest_control.jpeg) **Pest Control**                | 1          | `Uncommon`:&nbsp;4 | All your growing [Crops](#crops) increase their `Crop Value` by 1                                                                                                                                                                                                                                                                            |
| ![Supernatural Selection](../assets/thumbs/assets/actions/SMALL/jpeg/supernatural_selection.jpeg) **Supernatural Selection** | 3          | `Uncommon`:&nbsp;4 | Pick any other [Card](#cards) in your [Hand](#hand) and increase its `Card Value` by 4                                                                                                                                                                                                                                                       |
|                ![Flower Power](../assets/thumbs/assets/actions/SMALL/jpeg/flower_power.jpeg) **Flower Power**                | 3          | `Uncommon`:&nbsp;4 | Gain 1 [Fertilizer](#fertilizers) for each unique growing [Crop](#crops) on the game field                                                                                                                                                                                                                                                   |
|                 ![Fungus Flay](../assets/thumbs/assets/actions/SMALL/jpeg/fungus_flay.jpeg) **Fungus Flay**                  | 3          | `Uncommon`:&nbsp;4 | All currently growing [Crops](#crops) of a chosen `Color` in the game field lose 1&nbsp;`Crop Value`, down to 0. Does not affect [Crops](#crops) in **Greenhouses**.                                                                                                                                                                         |
|        ![Surging Seedlings](../assets/thumbs/assets/actions/SMALL/jpeg/surging_seedlings.jpeg) **Surging Seedlings**         | 3          | `Uncommon`:&nbsp;4 | For each empty **Garden Bed** you have, draw 1 [Card](#cards) from the [Deck](#deck)                                                                                                                                                                                                                                                         |
|                ![Thorny Fence](../assets/thumbs/assets/actions/SMALL/jpeg/thorny_fence.jpeg) **Thorny Fence**                | 3          |     `Rare`:&nbsp;3 | All [Cards](#cards) in a chosen Player's [Hand](#hand) lose 1&nbsp;`Card Value`                                                                                                                                                                                                                                                              |
|           ![Soil Enrichment](../assets/thumbs/assets/actions/SMALL/jpeg/soil_enrichment.jpeg) **Soil Enrichment**            | 2          |     `Rare`:&nbsp;3 | All currently growing [Crops](#crops) in your beds have their _Ripe Timer_ reduced by 1                                                                                                                                                                                                                                                      |
|                 ![Seed Sprout](../assets/thumbs/assets/actions/SMALL/jpeg/seed_sprout.jpeg) **Seed Sprout**                  | 3          |     `Rare`:&nbsp;3 | Draw 1 [Card](#cards) from the [Deck](#deck) for each unique `Color` of growing [Crops](#crops) in your garden, up to 3                                                                                                                                                                                                                      |
|           ![Pollen Paradise](../assets/thumbs/assets/actions/SMALL/jpeg/pollen_paradise.jpeg) **Pollen Paradise**            | 2          |     `Rare`:&nbsp;3 | Take two [Cards](#cards) from the [Deck](#deck). Pick 1 [Card](#cards) to be added to your [Hand](#hand), return another one to the [Deck](#deck). Gain 1 [Fertilizer](#fertilizers) for each [Card](#cards) in your [Hand](#hand), that is of the same `Color` as the one you've just picked                                                |
| ![Retractable Greenhouse](../assets/thumbs/assets/actions/SMALL/jpeg/retractable_greenhouse.jpeg) **Retractable Greenhouse** | 1          |     `Rare`:&nbsp;3 | Transform any [Bed](#garden-beds) into `Greenhouse`, keeping the [Crop](#crops) safe.                                                                                                                                                                                                                                                        | 
|                ![Garden Gnome](../assets/thumbs/assets/actions/SMALL/jpeg/garden_gnome.jpeg) **Garden Gnome**                | 1          |     `Rare`:&nbsp;3 | Every Opponent discards 1 random [Card](#cards) from their [Hand](#hand) for every `Card Value` of this [Card](#cards)                                                                                                                                                                                                                       |
|                 ![Trellis Bed](../assets/thumbs/assets/actions/SMALL/jpeg/trellis_bed.jpeg) **Trellis Bed**                  | 2          |     `Epic`:&nbsp;2 | Transform any [Bed](#garden-beds) into `Trellis`                                                                                                                                                                                                                                                                                             |
|                ![Vertical Bed](../assets/thumbs/assets/actions/SMALL/jpeg/vertical_bed.jpeg) **Vertical Bed**                | 2          |     `Epic`:&nbsp;2 | Transform any [Bed](#garden-beds) into `Vertical Bed`                                                                                                                                                                                                                                                                                        |
|             ![Rotational Bed](../assets/thumbs/assets/actions/SMALL/jpeg/rotational_bed.jpeg) **Rotational Bed**             | 2          |     `Epic`:&nbsp;2 | Transform any [Bed](#garden-beds) into `Rotational Bed`                                                                                                                                                                                                                                                                                      |
|             ![Waste Disposal](../assets/thumbs/assets/actions/SMALL/jpeg/waste_disposal.jpeg) **Waste Disposal**             | 3          |     `Epic`:&nbsp;2 | Choose any **Player**. For every card in their [Hand](#hand), their growing [Crops](#crops) lose 1&nbsp;`Crop Value`                                                                                                                                                                                                                         |
|          ![Cartel Agreement](../assets/thumbs/assets/actions/SMALL/jpeg/cartel_agreement.jpeg) **Cartel Agreement**          | 4          |     `Epic`:&nbsp;2 | Take 1 random [Card](#cards) from the [Market](#market) and add it to your [Hand](#hand). Then, return the remaining [Cards](#cards) from the [Market](#market) to the [Deck](#deck) randomly and refill the [Market](#market)                                                                                                               |
|             ![Chemical Bliss](../assets/thumbs/assets/actions/SMALL/jpeg/chemical_bliss.jpeg) **Chemical Bliss**             | 1          | `Mythical`:&nbsp;1 | Roll d6 for each unit of this `Card Value`. Gain as many [Fertilizers](#fertilizers)                                                                                                                                                                                                                                                         |
|                       ![Drought](../assets/thumbs/assets/actions/SMALL/jpeg/drought.jpeg) **Drought**                        | 4          | `Mythical`:&nbsp;1 | All currently growing [Crops](#crops) have their _Ripe Timer_ increased by 2                                                                                                                                                                                                                                                                 |
|                          ![Clone](../assets/thumbs/assets/actions/SMALL/jpeg/clone.jpeg) **Clone**                           | 4          | `Mythical`:&nbsp;1 | Choose any growing [Crop](#crops). Add an identical [Crop Card](#crop-cards) to your [Hand](#hand)                                                                                                                                                                                                                                           |
|                         ![Wither](../assets/thumbs/assets/actions/SMALL/jpeg/wither.jpeg) **Wither**                         | 3          | `Mythical`:&nbsp;1 | Choose any growing [Crop](#crops). It is destroyed, and the [Crop Card](#crop-cards) is discarded                                                                                                                                                                                                                                            |
|               ![Demon of Harvest](../assets/thumbs/assets/actions/SMALL/jpeg/demon.jpeg) **Demon of Harvest**                | 0          | `Mythical`:&nbsp;1 | Roll 1d20. <br/>On 20, immediately collect _all_ growing [Crops](#crops) in the Game. <br/>Otherwise, discard that many [Fertilizer](#fertilizers) and take any combination of [Cards](#cards) from the [Market](#market) for the same price or less. <br/>If you don't have enough [Fertilizers](#fertilizers), all your growing Crops die. |

## Classes

Every Player is playing a certain [Class](#classes), which defines his set of [Beds](#garden-beds),
...
|:-------------------------------------------------------------------------------------------------------:|-------------------------------------------------|------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
|        ![Land Baron](../assets/thumbs/assets/classes/SMALL/jpeg/land_baron.jpeg) **Land Baron**         | +2 [Coins](#coins)                              | 1&nbsp;`Common`<br/> 2&nbsp;`Greenhouse`                                           | ![Land Reclamation](../assets/thumbs/assets/actions/SMALL/jpeg/land_reclamation.jpeg) `Land Reclamation`: once per game, pick a [Card](#cards) you previously discarded and add two copies of it to your [Hand](#hand)                                              | 4 [Fertilizers](#fertilizers) |
|       ![Grim Reaper](../assets/thumbs/assets/classes/SMALL/jpeg/grim_reaper.jpeg) **Grim Reaper**       | +2 [Fertilizers](#fertilizers)                  | 1&nbsp;`Common`<br/> 2&nbsp;`Raised`                                               | ![Rip And Sow](../assets/thumbs/assets/actions/SMALL/jpeg/reap_and_sow.jpeg) `Reap And Sow`:  once per game, choose a [Crop](#crops) `Color`. All Opponents give you all their [Crop Cards](#crop-cards) of that `Color`, if they have any                          | 3 [Fertilizers](#fertilizers) |
| ![Master Gardener](../assets/thumbs/assets/classes/SMALL/jpeg/master_gardener.jpeg) **Master Gardener** | Extra [Beds](#garden-beds)                      | 1&nbsp;`Common`<br/>1&nbsp;`Trellis`<br/>1&nbsp;`Vertical`<br/>1&nbsp;`Rotational` | ![Early Bird](../assets/thumbs/assets/actions/SMALL/jpeg/early_bird.jpeg) `Early Bird`: once per game, Harvest all your growing [Crops](#crops) immediately. Draw a [Card](#cards) from the [Deck](#deck)                                                           | 3 [Fertilizers](#fertilizers) |
|  ![Crop Scientist](../assets/thumbs/assets/classes/SMALL/jpeg/crop_scientist.jpeg) **Crop Scientist**   | +1 Random `Common` [Action Card](#action-cards) | 1&nbsp;`Common`<br/>2&nbsp;`Hydroponic`                                            | ![Genetic Modification](../assets/thumbs/assets/actions/SMALL/jpeg/genetic_modification.jpeg) `Genetic Modification`: once per game, all your growing [Crops](#crops) have their `Crop Value` doubled                                                               | 2 [Fertilizer](#fertilizers)  |
|       ![Seed Trader](../assets/thumbs/assets/classes/SMALL/jpeg/seed_trader.jpeg) **Seed Trader**       | +1 Random `Common` [Crop Card](#crop-cards)     | 1&nbsp;`Common`<br/> 1&nbsp;`Greenhouse`<br/> 1&nbsp;`Raised`                      | ![Black Friday](../assets/thumbs/assets/actions/SMALL/jpeg/black_friday.jpeg) `Black Friday`: All Players ' _[Hands](#hand)_ are returned to the [Deck](#deck). [Market](#market) [Cards](#cards) are discarded. For every [Card](#cards) affected, gain **1 Coin** | 4 [Fertilizers](#fertilizers) |
| ![Weather Watcher](../assets/thumbs/assets/classes/SMALL/jpeg/weather_watcher.jpeg) **Weather Watcher** | +1 [Fertilizer](#fertilizers), +1 **Coin**      | 1&nbsp;`Common`<br/> 1&nbsp;`Greenhouse`<br/> 1&nbsp;`Hydroponic`                  | ![Cloud Cover](../assets/thumbs/assets/actions/SMALL/jpeg/cloud_cover.jpeg) `Cloud Cover`: once per game, chosen Opponent's [Crops](#crops) randomly add 1d4 to their `Reap Timer`.                                                                                 | 2 [Fertilizers](#fertilizers) |
