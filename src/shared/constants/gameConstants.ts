import { TCard, TCardType } from '~/shared/types/serializables/cards';
import { TCropColor, TGardenBedType } from '~/shared/types/serializables/crops';
import { TPlayer, TPlayerClass } from '~/shared/types/serializables/players';
