import { TPlayerIndex, TTrade } from '~/shared/types/fsm/shared';
import { TTargetModeContext } from '~/shared/types/fsm/slices/target';
import { TGameEffect } from '~/shared/types/fsm';
import { TPlayerTarget } from '~/shared/types/serializables/players';
