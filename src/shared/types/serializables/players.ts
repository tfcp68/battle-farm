import { TTargetMode, TTargetModeContext } from '~/shared/types/fsm/slices/target';
import { ICard, TCard } from '~/shared/types/serializables/cards';
import { TBed, TCrop, TGardenBedType } from '~/shared/types/serializables/crops';
