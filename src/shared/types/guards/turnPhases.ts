import { TTurnPhase, TTurnSubphaseAction, TTurnSubphaseContext } from '~/shared/types/fsm';
import { TFertilizeAction, TFertilizePhase } from '~/shared/types/fsm/slices/fertilize';
