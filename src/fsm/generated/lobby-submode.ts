...
functionDictionary.register('empty_map', function() {
						return (function() {
					const func = functionDictionary.get('zip');
					return func([], []);
				})();
					});
functionDictionary.register('reset_map', function(players) {
						return (function() {
					const func = functionDictionary.get('zip');
...
eventAdapter.addEventEmitter(
		...
		const eventsToEmit = [
			{
			event: eventDictionary["game_start"],
			meta: {
				gameId: (function(){
			const boundValue = (function(){
						if(context !== null && context['gameId'] !== undefined && context['gameId'] !== null) {
...
return [EventBus, automatas];
  ...
  "IN_GAME": "IN_GAME"
			...
			const byPassedStates = new Set([1334907897,94228390,85920701,1290510598,2630534,1032785389])
			export type TActionsLobbySubmodeAutomata = keyof typeof actionsMap;
	...
	playerReadyMap: (function(){
						if(prevContext !== null && prevContext['playerReadyMap'] !== undefined && prevContext['playerReadyMap'] !== null) {
							return prevContext['playerReadyMap']
								...
								return functionDictionary.get('empty_map')()
							}
					}()),
	...
	1334907897: (prevContext, payload, functionDictionary, automata) => {
	...
	72606646: (prevContext, payload, functionDictionary, automata) => {

				return prevContext
			},
	94228390: (prevContext, payload, functionDictionary, automata) => {

				return {playerReadyMap: (function(){
			const boundValue = (function(){
						return functionDictionary.get('setAttr')((function(){
						if(prevContext !== null && prevContext['playerReadyMap'] !== undefined && prevContext['playerReadyMap'] !== null) {
							return prevContext['playerReadyMap']
	...
	85920701: (prevContext, payload, functionDictionary, automata) => {
	...
	1290510598: (prevContext, payload, functionDictionary, automata) => {

				return {playerReadyMap: (function(){
			const boundValue = (function(){
						return functionDictionary.get('reset_map')(functionDictionary.get('omit')(functionDictionary.get('keys')((function(){
						if(prevContext !== null && prevContext['playerReadyMap'] !== undefined && prevContext['playerReadyMap'] !== null) {
							return prevContext['playerReadyMap']
						}
							else {
	...
	2630534: (prevContext, payload, functionDictionary, automata) => {
	...
	1032785389: (prevContext, payload, functionDictionary, automata) => {
				...
				return {playerIds: (function(){
			const boundValue = (function(){
						return functionDictionary.get('keys')((function(){
						if(prevContext !== null && prevContext['playerReadyMap'] !== undefined && prevContext['playerReadyMap'] !== null) {
							return prevContext['playerReadyMap']
						}
							else {
	...
	1608719668: (prevContext, payload, functionDictionary, automata) => {
			...
			const predicates = {
		2630534: { 88939: (prevContext, payload, functionDictionary) => {
...
72606646: { 2306630: (prevContext, payload, functionDictionary) => {
...
85920701: { 88939: (prevContext, payload, functionDictionary) => {
...
94228390: { 88939: (prevContext, payload, functionDictionary) => {
...
1290510598: { 88939: (prevContext, payload, functionDictionary) => {
...
export class LobbySubmodeAutomata extends GenericAutomata {

    static id = 'LobbySubmodeAutomata_1774195154798';
    static actions = actionsMap;
    static states = statesMap;
    static getState = (state: keyof typeof statesMap) => statesDictionary[state];
    static hasState = (instance: LobbySubmodeAutomata, state: keyof typeof LobbySubmodeAutomata.states) => instance.state === LobbySubmodeAutomata.getState(state);
    ...
    static createAction = (action: keyof typeof actionsMap, payload:any) => {
		const actionId = LobbySubmodeAutomata.getAction(action);
		return {
			action: actionId,
			payload,
		}
...
export default LobbySubmodeAutomata;
			const epoch = { val: 1 };
const incrementEpoch = () => { epoch.val++ };
const getEpoch = () => epoch.val;
			const internals = {
	...internalFunctions,
	"currentStateId": internalFunctions.currentStateId(LobbySubmodeAutomata),
	"currentStateName": internalFunctions.currentStateName(LobbySubmodeAutomata, statesDictionary),
	"currentActionId": internalFunctions.currentActionId(LobbySubmodeAutomata),
	"currentActionName": internalFunctions.currentActionName(LobbySubmodeAutomata, actionsDictionary),
	"currentCycle": internalFunctions.currentCycle(LobbySubmodeAutomata),
