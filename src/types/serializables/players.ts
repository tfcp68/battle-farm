import { TTargetMode, TTargetModeContext } from '~/types/fsm/slices/target';
import { ICard, TCard } from '~/types/serializables/cards';
import { TBed, TCrop, TGardenBedType } from '~/types/serializables/crops';
